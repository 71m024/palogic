...
namespace Boxenmieten\AppBundle\Menu;
...
class Builder
{
    ...
    public function createMainMenu(Request $request)
    {
        ...
        $menu->addChild($rentMenu);
            $categoryRepository = $this->em->getRepository('BoxenmietenBlogBundle:Category');
            ...
            $blogMenu = $this->factory->createItem('Blog', array('route' => 'boxenmieten_blog',
                'extras' => array(
                    'routes' => array('boxenmieten_blog_category_page', 'boxenmieten_blog_category'),
                )));
            foreach($categories as $category) {
                $blogMenu->addChild($category->getName(), array('route' => 'boxenmieten_blog_category',
