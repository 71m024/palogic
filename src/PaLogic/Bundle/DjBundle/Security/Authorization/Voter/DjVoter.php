...
namespace PaLogic\Bundle\DjBundle\Security\Authorization\Voter;
...
class DjVoter implements VoterInterface
{
    const VIEW = 'view';
    const EDIT = 'edit';
    ...
    {
        $supportedClass = 'PaLogic\Bundle\DjBundle\Entity\Dj';
     ...
     */
    public function vote(TokenInterface $token, $dj, array $attributes)
    {
        
        // check if class of this object is supported by this voter
        if (!$this->supportsClass(get_class($dj))) {
        ...
        if ($user->getId() === $dj->getOwner()->getId()) {
            return VoterInterface::ACCESS_GRANTED;
        }
