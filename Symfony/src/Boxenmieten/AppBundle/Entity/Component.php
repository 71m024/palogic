 ...
 * @ORM\Entity(repositoryClass="Boxenmieten\AppBundle\Entity\Repository\ComponentRepository")
 * @ORM\InheritanceType("JOINED")
 * @ORM\DiscriminatorColumn(name="discr", type="string")
 * @ORM\DiscriminatorMap({"boxe" = "Boxe", "stand" = "Stand", "cable" = "Cable", "mixer" = "Mixer"})
 */
class Component
{
    /**
     ...
     * Add sets
     *
     * @param \Boxenmieten\AppBundle\Entity\SetComponent $sets
     * @return Component
     */
    public function addSet(\Boxenmieten\AppBundle\Entity\SetComponent $sets)
    {
        $this->sets[] = $sets;
     ...
     * @param \Boxenmieten\AppBundle\Entity\SetComponent $sets
     */
    public function removeSet(\Boxenmieten\AppBundle\Entity\SetComponent $sets)
    {
